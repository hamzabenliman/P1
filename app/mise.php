...
<h1>Misse a jours</h1>
    <div class="container">
        ...
        <form action="mise.php" method="POST" enctype="multipart/form-data">
        <div class="form-group row">
            <label for="inputText3" class="col-sm-2 col-form-label">Entrez num de votre athlete :</label>
            <div class="col-sm-10">
...
mise_a_jour($num,$nom,$prenom,$daten,$ville,$photo);
    img();
}
?>
